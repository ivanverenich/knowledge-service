---
id: M00-T13
title: "Validate planning-document links"
milestone: M00
track: critical
depends_on: ["M00-T12"]
estimate: 75m
...
Add a repeatable Markdown link/front-matter validation command and repair any broken internal curriculum links.
...
2. Add a repeatable Markdown link/front-matter validation command and repair any broken internal curriculum links.
...
- The validator detects a planted broken dependency/link and passes after repair.
...
**Implementation prompt:** Inspect M00-T13 and its prerequisites. Explain the current seam and propose a task-scoped plan for: “Add a repeatable Markdown link/front-matter validation command and repair any broken internal curriculum links.” Wait for approval before editing; then report changed files and exact verification results.

**Review prompt:** Review M00-T13 for contract correctness, async/resource safety, security, deterministic tests, and scope. Lead with actionable findings tied to files and behavior; state explicitly if no finding remains.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m00-t13: validate documentation links`.
