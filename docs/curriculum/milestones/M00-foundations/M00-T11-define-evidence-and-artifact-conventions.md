---
id: M00-T11
title: "Define evidence and artifact conventions"
milestone: M00
track: critical
depends_on: ["M00-T10"]
estimate: 45m
...
Document where task evidence, benchmark summaries, evaluation results, and generated reports live and which sensitive artifacts must stay uncommitted.
...
2. Document where task evidence, benchmark summaries, evaluation results, and generated reports live and which sensitive artifacts must stay uncommitted.
...
- A sample harmless artifact is retained while a sample sensitive path is ignored and documented.
...
**Implementation prompt:** Inspect M00-T11 and its prerequisites. Explain the current seam and propose a task-scoped plan for: “Document where task evidence, benchmark summaries, evaluation results, and generated reports live and which sensitive artifacts must stay uncommitted.” Wait for approval before editing; then report changed files and exact verification results.

**Review prompt:** Review M00-T11 for contract correctness, async/resource safety, security, deterministic tests, and scope. Lead with actionable findings tied to files and behavior; state explicitly if no finding remains.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m00-t11: define evidence and artifact conventions`.
