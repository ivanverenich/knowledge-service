---
id: M11-T13
title: "Evaluate agentic research"
milestone: M11
track: optional
depends_on: ["M11-T12"]
estimate: 90m
topics: ["langgraph","mcp","multi-agent"]
deliverables: ["agent comparison report"]
status: planned
---

# M11-T13 — Evaluate agentic research

## Outcome

Create a multi-hop subset and compare deterministic RAG, single-agent, and multi-agent quality, citation support, latency, and cost.
...
2. Create a multi-hop subset and compare deterministic RAG, single-agent, and multi-agent quality, citation support, latency, and cost.
...
- The report includes confidence intervals/limitations and a promotion or rejection decision.
...
**Implementation prompt:** Inspect M11-T13, prerequisites, and current interfaces. Propose a bounded plan for: “Create a multi-hop subset and compare deterministic RAG, single-agent, and multi-agent quality, citation support, latency, and cost.” Wait for approval; then report changes, tests/drills, spend, and residual risk.

**Review prompt:** Review M11-T13 for interface leakage, identity/budget propagation, failure recovery, reproducibility, supply-chain risk, and misleading success claims. Lead with evidence-backed findings.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m11-t13: evaluate agentic research`.
