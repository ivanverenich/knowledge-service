---
id: M11-T15
title: "Document agent operating policy"
milestone: M11
track: optional
depends_on: ["M11-T14"]
estimate: 60m
topics: ["langgraph","mcp","multi-agent"]
deliverables: ["agent operating policy"]
status: planned
---

# M11-T15 — Document agent operating policy

## Outcome

Write limits, enabled tools, evidence labeling, human-review points, incident response, and criteria for enabling workflows.
...
2. Write limits, enabled tools, evidence labeling, human-review points, incident response, and criteria for enabling workflows.
...
- Operators can determine what an agent may do without reading graph code.
...
**Implementation prompt:** Inspect M11-T15, prerequisites, and current interfaces. Propose a bounded plan for: “Write limits, enabled tools, evidence labeling, human-review points, incident response, and criteria for enabling workflows.” Wait for approval; then report changes, tests/drills, spend, and residual risk.

**Review prompt:** Review M11-T15 for interface leakage, identity/budget propagation, failure recovery, reproducibility, supply-chain risk, and misleading success claims. Lead with evidence-backed findings.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m11-t15: document agent operating policy`.
