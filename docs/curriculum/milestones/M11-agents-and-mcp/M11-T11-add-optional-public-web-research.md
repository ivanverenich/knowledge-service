---
id: M11-T11
title: "Add optional public-web research"
milestone: M11
track: optional
depends_on: ["M11-T10"]
estimate: 90m
topics: ["langgraph","mcp","multi-agent"]
deliverables: ["public-web tool policy"]
status: planned
---

# M11-T11 — Add optional public-web research

## Outcome

Introduce a disabled-by-default search/fetch tool with domain policy, robots/licensing awareness, provenance, and clear Answer labeling.
...
2. Introduce a disabled-by-default search/fetch tool with domain policy, robots/licensing awareness, provenance, and clear Answer labeling.
...
- Configuration, audit, and output tests prove web access cannot activate implicitly.
...
**Implementation prompt:** Inspect M11-T11, prerequisites, and current interfaces. Propose a bounded plan for: “Introduce a disabled-by-default search/fetch tool with domain policy, robots/licensing awareness, provenance, and clear Answer labeling.” Wait for approval; then report changes, tests/drills, spend, and residual risk.

**Review prompt:** Review M11-T11 for interface leakage, identity/budget propagation, failure recovery, reproducibility, supply-chain risk, and misleading success claims. Lead with evidence-backed findings.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m11-t11: add optional public web research`.
