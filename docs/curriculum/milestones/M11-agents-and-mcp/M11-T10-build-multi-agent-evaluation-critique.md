---
id: M11-T10
title: "Build multi-agent evaluation critique"
milestone: M11
track: optional
depends_on: ["M11-T09"]
estimate: 90m
topics: ["langgraph","mcp","multi-agent"]
deliverables: ["evaluation critique graph"]
status: planned
---

# M11-T10 — Build multi-agent evaluation critique

## Outcome

Use separate proposal and critique roles to suggest difficult Evaluation Cases while retaining human approval and dataset lineage.
...
2. Use separate proposal and critique roles to suggest difficult Evaluation Cases while retaining human approval and dataset lineage.
...
- Generated cases remain drafts and duplicate/leaky/unsupported proposals are rejected.
...
**Implementation prompt:** Inspect M11-T10, prerequisites, and current interfaces. Propose a bounded plan for: “Use separate proposal and critique roles to suggest difficult Evaluation Cases while retaining human approval and dataset lineage.” Wait for approval; then report changes, tests/drills, spend, and residual risk.

**Review prompt:** Review M11-T10 for interface leakage, identity/budget propagation, failure recovery, reproducibility, supply-chain risk, and misleading success claims. Lead with evidence-backed findings.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m11-t10: build multi agent evaluation critique`.
