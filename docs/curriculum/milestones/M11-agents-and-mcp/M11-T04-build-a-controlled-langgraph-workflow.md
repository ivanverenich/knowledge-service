---
id: M11-T04
title: "Build a controlled LangGraph workflow"
milestone: M11
track: optional
depends_on: ["M11-T03"]
estimate: 90m
topics: ["langgraph","mcp","multi-agent"]
deliverables: ["LangGraph workflow"]
status: planned
---

# M11-T04 — Build a controlled LangGraph workflow

## Outcome

Implement meaningful branches for planning, authorized retrieval, evidence sufficiency, bounded retry, verification, and human review.
...
2. Implement meaningful branches for planning, authorized retrieval, evidence sufficiency, bounded retry, verification, and human review.
...
- Graph tests exercise every edge and resume from a persisted interruption.
...
**Implementation prompt:** Inspect M11-T04, prerequisites, and current interfaces. Propose a bounded plan for: “Implement meaningful branches for planning, authorized retrieval, evidence sufficiency, bounded retry, verification, and human review.” Wait for approval; then report changes, tests/drills, spend, and residual risk.

**Review prompt:** Review M11-T04 for interface leakage, identity/budget propagation, failure recovery, reproducibility, supply-chain risk, and misleading success claims. Lead with evidence-backed findings.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m11-t04: build a controlled langgraph workflow`.
