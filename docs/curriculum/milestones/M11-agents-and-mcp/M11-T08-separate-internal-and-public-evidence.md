---
id: M11-T08
title: "Separate internal and public evidence"
milestone: M11
track: optional
depends_on: ["M11-T07"]
estimate: 75m
topics: ["langgraph","mcp","multi-agent"]
deliverables: ["evidence-origin policy"]
status: planned
---

# M11-T08 — Separate internal and public evidence

## Outcome

Label organizational versus public-web/tool Evidence and require separate citation/provenance rendering and policy controls.
...
2. Label organizational versus public-web/tool Evidence and require separate citation/provenance rendering and policy controls.
...
- Answers cannot present external content as organizational policy or merge authorization semantics.
...
**Implementation prompt:** Inspect M11-T08, prerequisites, and current interfaces. Propose a bounded plan for: “Label organizational versus public-web/tool Evidence and require separate citation/provenance rendering and policy controls.” Wait for approval; then report changes, tests/drills, spend, and residual risk.

**Review prompt:** Review M11-T08 for interface leakage, identity/budget propagation, failure recovery, reproducibility, supply-chain risk, and misleading success claims. Lead with evidence-backed findings.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m11-t08: separate internal and public evidence`.
