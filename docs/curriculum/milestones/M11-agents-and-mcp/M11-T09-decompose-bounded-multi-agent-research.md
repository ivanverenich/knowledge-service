---
id: M11-T09
title: "Decompose bounded multi-agent research"
milestone: M11
track: optional
depends_on: ["M11-T08"]
estimate: 90m
topics: ["langgraph","mcp","multi-agent"]
deliverables: ["multi-agent research graph"]
status: planned
---

# M11-T09 — Decompose bounded multi-agent research

## Outcome

Implement planner, retriever, synthesizer, and verifier roles as explicit subgraphs sharing budgets and typed artifacts rather than free-form chat.
...
2. Implement planner, retriever, synthesizer, and verifier roles as explicit subgraphs sharing budgets and typed artifacts rather than free-form chat.
...
- Scripted tests expose disagreement, missing evidence, budget exhaustion, and verifier rejection.
...
**Implementation prompt:** Inspect M11-T09, prerequisites, and current interfaces. Propose a bounded plan for: “Implement planner, retriever, synthesizer, and verifier roles as explicit subgraphs sharing budgets and typed artifacts rather than free-form chat.” Wait for approval; then report changes, tests/drills, spend, and residual risk.

**Review prompt:** Review M11-T09 for interface leakage, identity/budget propagation, failure recovery, reproducibility, supply-chain risk, and misleading success claims. Lead with evidence-backed findings.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m11-t09: decompose bounded multi agent research`.
