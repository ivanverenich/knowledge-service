---
id: M15-T15
title: "Make the build-versus-buy decision"
milestone: M15
track: optional
depends_on: ["M15-T14"]
estimate: 75m
topics: ["ollama","vllm","qlora"]
deliverables: ["model strategy decision"]
status: planned
---

# M15-T15 — Make the build-versus-buy decision

## Outcome

Compare managed, Ollama, and vLLM/tuned paths across quality, privacy, latency, throughput, operations, portability, and cost.
...
2. Compare managed, Ollama, and vLLM/tuned paths across quality, privacy, latency, throughput, operations, portability, and cost.
...
- A concise decision identifies the default and conditions that would change it.
...
**Implementation prompt:** Inspect M15-T15, prerequisites, current interfaces, and cost/security constraints. Propose a bounded plan for: “Compare managed, Ollama, and vLLM/tuned paths across quality, privacy, latency, throughput, operations, portability, and cost.” Wait for approval; report changes, exact validation, spend, and teardown.

**Review prompt:** Review M15-T15 for state/secret exposure, least privilege, version drift, cost risk, cleanup, reproducibility, evaluation validity, and interface leakage. Lead with evidence-backed findings.

## Git checkpoint

Commit only after acceptance and teardown/rollback evidence exists, using intent: `m15-t15: make the build versus buy decision`.
