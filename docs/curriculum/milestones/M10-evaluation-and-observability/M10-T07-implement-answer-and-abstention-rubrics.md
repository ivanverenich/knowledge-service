---
id: M10-T07
title: "Implement Answer and abstention rubrics"
milestone: M10
track: critical
depends_on: ["M10-T06"]
estimate: 75m
topics: ["evaluation","opentelemetry","load-testing"]
deliverables: ["answer rubric","abstention scorer"]
status: planned
---

# M10-T07 — Implement Answer and abstention rubrics

## Outcome

Model structured correctness, completeness, faithfulness, and abstention judgments with deterministic validation and missing-score policy.
...
2. Model structured correctness, completeness, faithfulness, and abstention judgments with deterministic validation and missing-score policy.
...
- Hand-rated fixtures exercise every rubric level and aggregation rule.
...
**Implementation prompt:** Inspect M10-T07, its dependencies, and current evidence. Propose a bounded plan for: “Model structured correctness, completeness, faithfulness, and abstention judgments with deterministic validation and missing-score policy.” Wait for approval, then make only task-scoped changes and report exact checks and external spend.

**Review prompt:** Review M10-T07 for contract drift, authorization, idempotency, async cleanup, observability, test determinism, and hidden paid/network dependency. Lead with reproducible findings.

## Git checkpoint

Commit only with complete evidence, using intent: `m10-t07: implement answer and abstention rubrics`.
