---
id: M10-T03
title: "Snapshot a public technical corpus"
milestone: M10
track: critical
depends_on: ["M10-T02"]
estimate: 90m
topics: ["evaluation","opentelemetry","load-testing"]
deliverables: ["public corpus manifest","license inventory"]
status: planned
---

# M10-T03 — Snapshot a public technical corpus

## Outcome

Select English/Ukrainian software documentation with clear licenses, store a reproducible acquisition manifest, and avoid copying prohibited material.
...
2. Select English/Ukrainian software documentation with clear licenses, store a reproducible acquisition manifest, and avoid copying prohibited material.
...
- A checksum-based fetch/import process reconstructs the approved snapshot and license inventory.
...
**Implementation prompt:** Inspect M10-T03, its dependencies, and current evidence. Propose a bounded plan for: “Select English/Ukrainian software documentation with clear licenses, store a reproducible acquisition manifest, and avoid copying prohibited material.” Wait for approval, then make only task-scoped changes and report exact checks and external spend.

**Review prompt:** Review M10-T03 for contract drift, authorization, idempotency, async cleanup, observability, test determinism, and hidden paid/network dependency. Lead with reproducible findings.

## Git checkpoint

Commit only with complete evidence, using intent: `m10-t03: snapshot a public technical corpus`.
