---
id: M10-T08
title: "Implement Citation metrics"
milestone: M10
track: critical
depends_on: ["M10-T07"]
estimate: 75m
topics: ["evaluation","opentelemetry","load-testing"]
deliverables: ["citation scorers"]
status: planned
---

# M10-T08 — Implement Citation metrics

## Outcome

Score validity, precision, claim support, and source coverage separately so decorative Citations cannot inflate quality.
...
2. Score validity, precision, claim support, and source coverage separately so decorative Citations cannot inflate quality.
...
- Synthetic Answers with missing, excess, wrong, and strong Citations yield expected scores.
...
**Implementation prompt:** Inspect M10-T08, its dependencies, and current evidence. Propose a bounded plan for: “Score validity, precision, claim support, and source coverage separately so decorative Citations cannot inflate quality.” Wait for approval, then make only task-scoped changes and report exact checks and external spend.

**Review prompt:** Review M10-T08 for contract drift, authorization, idempotency, async cleanup, observability, test determinism, and hidden paid/network dependency. Lead with reproducible findings.
