---
id: M10-T10
title: "Calibrate judge against humans"
milestone: M10
track: critical
depends_on: ["M10-T09"]
estimate: 90m
topics: ["evaluation","opentelemetry","load-testing"]
deliverables: ["human calibration report"]
status: planned
---

# M10-T10 — Calibrate judge against humans

## Outcome

Collect blinded bilingual ratings from two reviewers on 30–50 cases and measure agreement and judge disagreement.
...
2. Collect blinded bilingual ratings from two reviewers on 30–50 cases and measure agreement and judge disagreement.
...
- A calibration report documents disagreements, rubric changes, and remaining bias.
...
**Implementation prompt:** Inspect M10-T10, its dependencies, and current evidence. Propose a bounded plan for: “Collect blinded bilingual ratings from two reviewers on 30–50 cases and measure agreement and judge disagreement.” Wait for approval, then make only task-scoped changes and report exact checks and external spend.

**Review prompt:** Review M10-T10 for contract drift, authorization, idempotency, async cleanup, observability, test determinism, and hidden paid/network dependency. Lead with reproducible findings.

## Git checkpoint

Commit only with complete evidence, using intent: `m10-t10: calibrate judge against humans`.
