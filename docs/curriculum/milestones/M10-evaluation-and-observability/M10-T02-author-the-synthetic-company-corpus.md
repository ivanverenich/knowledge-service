---
id: M10-T02
title: "Author the synthetic company corpus"
milestone: M10
track: critical
depends_on: ["M10-T01"]
estimate: 90m
topics: ["evaluation","opentelemetry","load-testing"]
deliverables: ["bilingual synthetic corpus","corpus manifest"]
status: planned
---

# M10-T02 — Author the synthetic company corpus

## Outcome

Create licensed bilingual organizational documents with deliberate overlap, contradictions, updates, tables, identifiers, and permission groups.
...
2. Create licensed bilingual organizational documents with deliberate overlap, contradictions, updates, tables, identifiers, and permission groups.
...
- Corpus manifest records provenance and enables deterministic re-ingestion.
...
**Implementation prompt:** Inspect M10-T02, its dependencies, and current evidence. Propose a bounded plan for: “Create licensed bilingual organizational documents with deliberate overlap, contradictions, updates, tables, identifiers, and permission groups.” Wait for approval, then make only task-scoped changes and report exact checks and external spend.

**Review prompt:** Review M10-T02 for contract drift, authorization, idempotency, async cleanup, observability, test determinism, and hidden paid/network dependency. Lead with reproducible findings.

## Git checkpoint

Commit only with complete evidence, using intent: `m10-t02: author the synthetic company corpus`.
