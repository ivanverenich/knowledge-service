---
id: M06-T12
title: "Resolve follow-up Questions"
milestone: M06
track: critical
depends_on: ["M06-T11"]
estimate: 90m
topics: ["generation","citations","sse"]
deliverables: ["follow-up resolver"]
status: planned
---

# M06-T12 — Resolve follow-up Questions

## Outcome

Use structured rewriting only for classified follow-ups and retain original language, entities, and traceable rewritten query.
...
2. Use structured rewriting only for classified follow-ups and retain original language, entities, and traceable rewritten query.
...
- Bilingual conversation cases measure retrieval with and without resolution.
...
**Implementation prompt:** Inspect M06-T12 and prerequisite evidence. Describe the existing seam and propose a scoped plan for: “Use structured rewriting only for classified follow-ups and retain original language, entities, and traceable rewritten query.” Wait for approval before edits; report changed files, tests, and unresolved risks.

**Review prompt:** Review M06-T12 for behavior, security/ACL ordering, async resource ownership, deterministic coverage, and accidental scope. Lead with findings tied to observable failures.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m06-t12: resolve follow up questions`.
