---
id: M06-T07
title: "Implement calibrated abstention"
milestone: M06
track: critical
depends_on: ["M06-T06"]
estimate: 90m
topics: ["generation","citations","sse"]
deliverables: ["abstention policy"]
status: planned
---

# M06-T07 — Implement calibrated abstention

## Outcome

Define evidence sufficiency signals and answer policy for empty, weak, conflicting, or unauthorized retrieval outcomes.
...
2. Define evidence sufficiency signals and answer policy for empty, weak, conflicting, or unauthorized retrieval outcomes.
...
- Evaluation cases distinguish correct abstention, over-abstention, and unsupported answers.
...
**Implementation prompt:** Inspect M06-T07 and prerequisite evidence. Describe the existing seam and propose a scoped plan for: “Define evidence sufficiency signals and answer policy for empty, weak, conflicting, or unauthorized retrieval outcomes.” Wait for approval before edits; report changed files, tests, and unresolved risks.

**Review prompt:** Review M06-T07 for behavior, security/ACL ordering, async resource ownership, deterministic coverage, and accidental scope. Lead with findings tied to observable failures.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m06-t07: implement calibrated abstention`.
