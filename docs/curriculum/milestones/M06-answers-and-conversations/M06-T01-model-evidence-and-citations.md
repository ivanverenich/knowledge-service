---
id: M06-T01
title: "Model Evidence and Citations"
milestone: M06
track: critical
depends_on: ["M05-T16"]
estimate: 75m
topics: ["generation","citations","sse"]
deliverables: ["Evidence model","Citation model"]
status: planned
---

# M06-T01 — Model Evidence and Citations

## Outcome

Define opaque Evidence IDs, provenance, excerpts, source links, and Citation references without allowing the model to invent source identity.
...
2. Define opaque Evidence IDs, provenance, excerpts, source links, and Citation references without allowing the model to invent source identity.
...
- Serialization and validation tests reject unknown, duplicated, or malformed references.
...
**Implementation prompt:** Inspect M06-T01 and prerequisite evidence. Describe the existing seam and propose a scoped plan for: “Define opaque Evidence IDs, provenance, excerpts, source links, and Citation references without allowing the model to invent source identity.” Wait for approval before edits; report changed files, tests, and unresolved risks.

**Review prompt:** Review M06-T01 for behavior, security/ACL ordering, async resource ownership, deterministic coverage, and accidental scope. Lead with findings tied to observable failures.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m06-t01: model evidence and citations`.
