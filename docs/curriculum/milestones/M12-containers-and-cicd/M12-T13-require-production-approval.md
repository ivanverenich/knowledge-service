...
deliverables: ["production promotion workflow"]
status: planned
---

# M12-T13 — Require production approval

## Outcome

Add protected approval, artifact identity verification, release evidence link, and recorded deploy actor for production.
...
2. Add protected approval, artifact identity verification, release evidence link, and recorded deploy actor for production.
...
- A release cannot substitute an untested tag or bypass required evidence.
...
**Implementation prompt:** Inspect M12-T13, prerequisites, and current interfaces. Propose a bounded plan for: “Add protected approval, artifact identity verification, release evidence link, and recorded deploy actor for production.” Wait for approval; then report changes, tests/drills, spend, and residual risk.

**Review prompt:** Review M12-T13 for interface leakage, identity/budget propagation, failure recovery, reproducibility, supply-chain risk, and misleading success claims. Lead with evidence-backed findings.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m12-t13: require production approval`.
