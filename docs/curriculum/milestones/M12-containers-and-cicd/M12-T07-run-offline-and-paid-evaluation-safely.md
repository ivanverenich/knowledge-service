---
id: M12-T07
title: "Run offline and paid evaluation safely"
milestone: M12
track: critical
depends_on: ["M12-T06"]
estimate: 90m
topics: ["docker","ci-cd","supply-chain"]
deliverables: ["evaluation CI workflows"]
status: planned
---

# M12-T07 — Run offline and paid evaluation safely

## Outcome

Keep deterministic evaluation on pull requests and gate credentialed scheduled/manual evaluation with budgets, protected environments, and retained reports.
...
2. Keep deterministic evaluation on pull requests and gate credentialed scheduled/manual evaluation with budgets, protected environments, and retained reports.
...
- Untrusted forks cannot access secrets; a manual run records spend and artifacts.
...
**Implementation prompt:** Inspect M12-T07, prerequisites, and current interfaces. Propose a bounded plan for: “Keep deterministic evaluation on pull requests and gate credentialed scheduled/manual evaluation with budgets, protected environments, and retained reports.” Wait for approval; then report changes, tests/drills, spend, and residual risk.

**Review prompt:** Review M12-T07 for interface leakage, identity/budget propagation, failure recovery, reproducibility, supply-chain risk, and misleading success claims. Lead with evidence-backed findings.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m12-t07: run offline and paid evaluation safely`.
