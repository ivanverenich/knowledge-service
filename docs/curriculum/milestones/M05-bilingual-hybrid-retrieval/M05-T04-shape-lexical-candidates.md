---
id: M05-T04
title: "Shape lexical Candidates"
milestone: M05
track: critical
depends_on: ["M05-T03"]
estimate: 75m
topics: ["hybrid-search","ukrainian","reranking"]
deliverables: ["lexical candidate adapter"]
status: planned
---

# M05-T04 — Shape lexical Candidates

## Outcome

Return the same Candidate/provenance contract as vector search, with rank, highlights, deterministic ties, ACL predicate slot, and bounded results.
...
2. Return the same Candidate/provenance contract as vector search, with rank, highlights, deterministic ties, ACL predicate slot, and bounded results.
...
- Vector and lexical adapters pass a shared Candidate contract suite.
...
**Implementation prompt:** Inspect M05-T04 and prerequisite evidence. Describe the existing seam and propose a scoped plan for: “Return the same Candidate/provenance contract as vector search, with rank, highlights, deterministic ties, ACL predicate slot, and bounded results.” Wait for approval before edits; report changed files, tests, and unresolved risks.

**Review prompt:** Review M05-T04 for behavior, security/ACL ordering, async resource ownership, deterministic coverage, and accidental scope. Lead with findings tied to observable failures.
