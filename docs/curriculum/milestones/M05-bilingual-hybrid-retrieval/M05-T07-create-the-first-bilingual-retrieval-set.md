---
id: M05-T07
title: "Create the first bilingual retrieval set"
milestone: M05
track: critical
depends_on: ["M05-T06"]
estimate: 90m
topics: ["hybrid-search","ukrainian","reranking"]
deliverables: ["seed bilingual dataset"]
status: planned
---

# M05-T07 — Create the first bilingual retrieval set

## Outcome

Author and verify a small corpus and cases for English, Ukrainian, identifiers, morphology, and both cross-language directions.
...
2. Author and verify a small corpus and cases for English, Ukrainian, identifiers, morphology, and both cross-language directions.
...
- Each case names relevant Documents/Chunks and a script can execute the set deterministically.
...
**Implementation prompt:** Inspect M05-T07 and prerequisite evidence. Describe the existing seam and propose a scoped plan for: “Author and verify a small corpus and cases for English, Ukrainian, identifiers, morphology, and both cross-language directions.” Wait for approval before edits; report changed files, tests, and unresolved risks.

**Review prompt:** Review M05-T07 for behavior, security/ACL ordering, async resource ownership, deterministic coverage, and accidental scope. Lead with findings tied to observable failures.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m05-t07: create the first bilingual retrieval set`.
