...
deliverables: ["RRF function"]
status: planned
---

# M05-T05 — Implement Reciprocal Rank Fusion

## Outcome

Fuse ranked dense and lexical lists by stable Chunk identity with configurable k and transparent score contributions.
...
2. Fuse ranked dense and lexical lists by stable Chunk identity with configurable k and transparent score contributions.
...
- Unit tests cover overlap, disjoint lists, missing branches, ties, and duplicated identities.
...
**Implementation prompt:** Inspect M05-T05 and prerequisite evidence. Describe the existing seam and propose a scoped plan for: “Fuse ranked dense and lexical lists by stable Chunk identity with configurable k and transparent score contributions.” Wait for approval before edits; report changed files, tests, and unresolved risks.

**Review prompt:** Review M05-T05 for behavior, security/ACL ordering, async resource ownership, deterministic coverage, and accidental scope. Lead with findings tied to observable failures.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m05-t05: implement reciprocal rank fusion`.
