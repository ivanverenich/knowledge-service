---
id: M13-T04
title: "Provision network isolation"
milestone: M13
track: critical
depends_on: ["M13-T03"]
estimate: 90m
topics: ["aws","terraform","ecs"]
deliverables: ["network module","network diagram"]
status: planned
---

# M13-T04 — Provision network isolation

## Outcome

Create VPC, public edge and private application/data subnets, routing, endpoints, security groups, and documented NAT cost choice.
...
2. Create VPC, public edge and private application/data subnets, routing, endpoints, security groups, and documented NAT cost choice.
...
- Reachability analysis shows only intended ingress/egress and no public database/Redis address.
...
**Implementation prompt:** Inspect M13-T04, prerequisites, current interfaces, and cost/security constraints. Propose a bounded plan for: “Create VPC, public edge and private application/data subnets, routing, endpoints, security groups, and documented NAT cost choice.” Wait for approval; report changes, exact validation, spend, and teardown.

**Review prompt:** Review M13-T04 for state/secret exposure, least privilege, version drift, cost risk, cleanup, reproducibility, evaluation validity, and interface leakage. Lead with evidence-backed findings.

## Git checkpoint

Commit only after acceptance and teardown/rollback evidence exists, using intent: `m13-t04: provision network isolation`.
