---
id: M02-T02
title: "Model Document and version invariants"
milestone: M02
track: critical
depends_on: ["M02-T01"]
estimate: 75m
...
Represent Document, Content Version, Authorization Version, availability, provenance, and timestamps without persistence imports.
...
2. Represent Document, Content Version, Authorization Version, availability, provenance, and timestamps without persistence imports.
...
- Tests cover unchanged content, ACL-only change, content change, and tombstoned state.
...
**Implementation prompt:** Inspect M02-T02 and its prerequisites. Explain the current seam and propose a task-scoped plan for: “Represent Document, Content Version, Authorization Version, availability, provenance, and timestamps without persistence imports.” Wait for approval before editing; then report changed files and exact verification results.

**Review prompt:** Review M02-T02 for contract correctness, async/resource safety, security, deterministic tests, and scope. Lead with actionable findings tied to files and behavior; state explicitly if no finding remains.
