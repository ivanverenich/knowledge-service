---
id: M07-T15
title: "Build the authorization adversarial suite"
milestone: M07
track: critical
depends_on: ["M07-T14"]
estimate: 90m
topics: ["oidc","authorization","security"]
deliverables: ["authorization regression suite"]
status: planned
---

# M07-T15 — Build the authorization adversarial suite

## Outcome

Generate users, nested group scenarios, identical public/private text, revocation races, direct IDs, and bilingual probes as reusable tests.
...
2. Generate users, nested group scenarios, identical public/private text, revocation races, direct IDs, and bilingual probes as reusable tests.
...
- The suite runs across retrieval, answer, citation, Conversation, and tool interfaces with zero leakage.
...
**Implementation prompt:** Inspect M07-T15 and prerequisite evidence. Describe the existing seam and propose a scoped plan for: “Generate users, nested group scenarios, identical public/private text, revocation races, direct IDs, and bilingual probes as reusable tests.” Wait for approval before edits; report changed files, tests, and unresolved risks.

**Review prompt:** Review M07-T15 for behavior, security/ACL ordering, async resource ownership, deterministic coverage, and accidental scope. Lead with findings tied to observable failures.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m07-t15: build the authorization adversarial suite`.
