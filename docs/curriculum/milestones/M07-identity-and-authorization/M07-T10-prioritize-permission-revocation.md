---
id: M07-T10
title: "Prioritize permission revocation"
milestone: M07
track: critical
depends_on: ["M07-T09"]
estimate: 90m
topics: ["oidc","authorization","security"]
deliverables: ["revocation workflow"]
status: planned
---

# M07-T10 — Prioritize permission revocation

## Outcome

Publish restrictive Authorization Versions before non-security work and invalidate in-flight access at defined consistency points.
...
2. Publish restrictive Authorization Versions before non-security work and invalidate in-flight access at defined consistency points.
...
- A concurrency test changes grants during a Conversation and proves later reads fail closed.
...
**Implementation prompt:** Inspect M07-T10 and prerequisite evidence. Describe the existing seam and propose a scoped plan for: “Publish restrictive Authorization Versions before non-security work and invalidate in-flight access at defined consistency points.” Wait for approval before edits; report changed files, tests, and unresolved risks.

**Review prompt:** Review M07-T10 for behavior, security/ACL ordering, async resource ownership, deterministic coverage, and accidental scope. Lead with findings tied to observable failures.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m07-t10: prioritize permission revocation`.
