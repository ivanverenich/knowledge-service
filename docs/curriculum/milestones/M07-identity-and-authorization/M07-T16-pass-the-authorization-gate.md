---
id: M07-T16
title: "Pass the authorization understanding gate"
milestone: M07
track: critical
depends_on: ["M07-T15"]
estimate: 90m
topics: ["oidc","authorization","security"]
deliverables: ["M07 gate evidence"]
status: planned
---

# M07-T16 — Pass the authorization understanding gate

## Outcome

Explain identity versus roles versus grants, update trust-zone diagrams, diagnose an injected leak, and add a new protected operation independently.
...
2. Explain identity versus roles versus grants, update trust-zone diagrams, diagnose an injected leak, and add a new protected operation independently.
...
- Evidence proves fail-closed behavior at storage and transport seams.
...
**Implementation prompt:** Inspect M07-T16 and prerequisite evidence. Describe the existing seam and propose a scoped plan for: “Explain identity versus roles versus grants, update trust-zone diagrams, diagnose an injected leak, and add a new protected operation independently.” Wait for approval before edits; report changed files, tests, and unresolved risks.

**Review prompt:** Review M07-T16 for behavior, security/ACL ordering, async resource ownership, deterministic coverage, and accidental scope. Lead with findings tied to observable failures.
