---
id: M07-T12
title: "Redact logs and traces"
milestone: M07
track: critical
depends_on: ["M07-T11"]
estimate: 90m
topics: ["oidc","authorization","security"]
deliverables: ["telemetry redaction"]
status: planned
---

# M07-T12 — Redact logs and traces

## Outcome

Create allowlisted telemetry fields and configurable development diagnostics while keeping raw Questions, Evidence, and Answers out by default.
...
2. Create allowlisted telemetry fields and configurable development diagnostics while keeping raw Questions, Evidence, and Answers out by default.
...
- Capture tests scan structured logs and spans for seeded secrets and document phrases.
...
**Implementation prompt:** Inspect M07-T12 and prerequisite evidence. Describe the existing seam and propose a scoped plan for: “Create allowlisted telemetry fields and configurable development diagnostics while keeping raw Questions, Evidence, and Answers out by default.” Wait for approval before edits; report changed files, tests, and unresolved risks.

**Review prompt:** Review M07-T12 for behavior, security/ACL ordering, async resource ownership, deterministic coverage, and accidental scope. Lead with findings tied to observable failures.

## Git checkpoint

Commit only after acceptance evidence exists, with intent: `m07-t12: redact logs and traces`.
